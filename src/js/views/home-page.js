...
function HomePageScreen() {
	...
	var self = this,
		startDate = new Date(2015, 5, 8, 12, 0, 0, 0),
		now = new Date(),
		voucherCTA,
		checkDate;
	...
	function loadEnterVoucherPage(e){
		...
		if (now >= startDate) {
			...
			var errorWrapper = document.getElementById('error-overlay'),
				...
				voucherError = 'You’re keen! It’s not quite time to enjoy a Piña Colada just yet though, you’ll have to wait until the 8th, 9th and 11th of July.';
